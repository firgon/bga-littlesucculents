...
class Cards extends \LSU\Helpers\Pieces
{
    ...
    public static function getCards()
    {
        ...
        return [
            ...
            21 => $littlesucculents_f([PLANT, 0, 0, 6, PINK, SET_A . PINK, 'BabyToes', 'Baby Toes']),
            22 => $littlesucculents_f([PLANT, 0, 0, 6, ORANGE, SET_A . ORANGE, 'SnakePlant', 'Snake Plant']),
            23 => $littlesucculents_f([PLANT, 0, 0, 6, YELLOW, SET_A . YELLOW, 'MexicanFirecracker', 'Mexican Firecracker']),
            24 => $littlesucculents_f([PLANT, 0, 0, 6, GREEN, SET_A . GREEN, 'StringofPearls', 'String of Pearls']),
            25 => $littlesucculents_f([PLANT, 0, 0, 6, BLUE, SET_A . BLUE, 'StringofDolphins', 'String of Dolphins']),
            26 => $littlesucculents_f([PLANT, 0, 0, 6, RED, SET_A . RED, 'JellybeanPlant', 'Jellybean Plant']),
            27 => $littlesucculents_f([PLANT, 0, 0, 6, PINK, SET_B . PINK, 'CalicoHearts', 'Calico Hearts']),
            28 => $littlesucculents_f([PLANT, 0, 0, 6, ORANGE, SET_B . ORANGE, 'BunnyEars', 'Bunny Ears']),
            29 => $littlesucculents_f([PLANT, 0, 0, 6, YELLOW, SET_B . YELLOW, 'RibbonPlant', 'Ribbon Plant']),
            30 => $littlesucculents_f([PLANT, 0, 0, 6, GREEN, SET_B . GREEN, 'BabySunRose', 'Baby Sun Rose']),
            31 => $littlesucculents_f([PLANT, 0, 0, 6, BLUE, SET_B . BLUE, 'CoralCactus', 'Coral Cactus']),
            32 => $littlesucculents_f([PLANT, 0, 0, 6, RED, SET_B . RED, 'LivingStone', 'Living Stone']),
            ...
            40 => $littlesucculents_f([PLANT, 0, 0, 4, GREY, STARTER . PLANT, 'MoneyPlant', 'Money Plant']),
