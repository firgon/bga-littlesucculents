 ...
 * -----
 * 
 * gretchensgarden.action.php
 *
 * GretchensGarden main action entry point
 *
 *
 ...
 * this.ajaxcall( "/gretchensgarden/gretchensgarden/myAction.html", ...)
 *
 */


class action_gretchensgarden extends APP_GameAction
{
  ...
  public function __default()
  {
    if (self::isArg('notifwindow')) {
      ...
      $this->view = "gretchensgarden_gretchensgarden";
