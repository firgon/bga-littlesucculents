...
var Generics = /** @class */ (function () {
    ...
    Generics.addTextDiv = function (text, classe, element, isAutofit) {
        if (isAutofit === void 0) { isAutofit = false; }
        var div = document.createElement("div");
        div.classList.add(classe);
        if (isAutofit)
            div.classList.add("bga-autofit");
...
var CardSetting = /** @class */ (function () {
    ...
    CardSetting.prototype.setupBackDiv = function (card, element) {
        if (card.location == "waterCan") {
            Generics.addTextDiv(_("Watering Can"), "title", element, true);
            Generics.addTextDiv(_("Tend Action:<br>+2 water in this can"), "text", element, true);
        }
    };
    ...
    CardSetting.prototype.setupFrontDiv = function (card, element) {
        ...
        if (card.type == "plant") {
            Generics.addTextDiv(this.animationManager.game.insertIcons(card.hint), "text", element, true);
...
var MyCardManager = /** @class */ (function (_super) {
    ...
    MyCardManager.prototype.addStatics = function (card) {
        var gretchensgarden_f = function (data) {
            return {
                type: data[0],
                maxLeaf: data[1],
                maxWater: data[2],
 ...
 * gretchensgarden.js
 *
 * gretchensgarden user interface script
 *
...
var GretchensGardenGame = /** @class */ (function (_super) {
    __extends(GretchensGardenGame, _super);
    function GretchensGardenGame() {
  ...
  ░░░░░░░░░  ░░░░░░░░░░    ░░░░░      ░░░░░░░░   ░░░░░
        ...
        */
    GretchensGardenGame.prototype.setup = function (gamedatas) {
    ...
    */
    GretchensGardenGame.prototype.onEnteringStateConfirm = function (args) {
        var _this = this;
        this.addUndoButton();
    ...
    GretchensGardenGame.prototype.onEnteringStateBabySunRose = function (args) {
        var _this = this;
    ...
    GretchensGardenGame.prototype.onEnteringStateClientBabySunRose = function (args) {
        this.initializeBabySunRosePhase(args);
    };
    GretchensGardenGame.prototype.initializeBabySunRosePhase = function (args) {
        var _this = this;
        var _a;
    ...
    GretchensGardenGame.prototype.onEnteringStateClientChooseLeafToTransfert = function (args) {
        var _this = this;
        this.initializeBabySunRosePhase(args);
    ...
    GretchensGardenGame.prototype.onEnteringStateMove = function (args) {
        var _this = this;
    ...
    GretchensGardenGame.prototype.onEnteringStatePlay = function (args) {
        var _this = this;
        //buy action
    ...
    GretchensGardenGame.prototype.onEnteringStateTend = function (args) {
        var _this = this;
    ...
    GretchensGardenGame.prototype.onUpdateActivityWater = function (args) {
        debug("update water", args);
        this.addResetButton();
    };
    GretchensGardenGame.prototype.onLeavingStateWater = function (args) {
        debug("leaving water", args);
        if (!this.isSpectator)
            $("watercan-" + this.player_id).replaceChildren();
    };
    GretchensGardenGame.prototype.onLeavingStateWaterSolo = function (args) {
        this.onLeavingStateWater(args);
    };
    GretchensGardenGame.prototype.onEnteringStateWaterSolo = function (args) {
        this.onEnteringStateWater(args);
        this.addUndoButton();
    };
    GretchensGardenGame.prototype.onEnteringStateWater = function (args) {
        var _this = this;
        if (this.isSpectator)
            return;
    ...
    GretchensGardenGame.prototype.onEnteringStateClientBuy = function (args) {
        var _this = this;
    ...
    GretchensGardenGame.prototype.onEnteringStateClientChooseDestination = function (args) {
        var _this = this;
        this.addResetClientStateButton();
    ...
    GretchensGardenGame.prototype.onEnteringStateClientCut = function (args) {
        var _this = this;
    ...
    GretchensGardenGame.prototype.onEnteringStateClientFlower = function (args) {
        var _this = this;
        this._stocks[this.player_id].setSelectionMode("single");
    ...
    //
    //
    GretchensGardenGame.prototype.takeDroplet = function (destination, playerId) {
    ...
    GretchensGardenGame.prototype.storeDroplet = function (source, playerId) {
        playerId = playerId !== null && playerId !== void 0 ? playerId : +this.player_id;
    ...
    //   });
    // }
    GretchensGardenGame.prototype.replaceUnusedDropletIntoCan = function (playerId) {
        var _this = this;
     ...
     */
    GretchensGardenGame.prototype.resetMoveToken = function () {
        var _this = this;
    ...
    GretchensGardenGame.prototype.storeWaterToken = function () {
        var _a;
        //select token
    ...
    GretchensGardenGame.prototype.planMoveToken = function (cardId) {
        var _a;
    ...
    ░░███  ░░███ ░█░░░███░░░█░░███ ░░███        ███░░░░░███
     ...
     ░░████████      █████    █████ ███████████░░█████████
      ░░░░░░░░      ░░░░░    ░░░░░ ░░░░░░░░░░░  ░░░░░░░░░
    */
    GretchensGardenGame.prototype.areDropletsRemaining = function () {
        return document.querySelectorAll("#token-container .token").length != 0;
    };
    GretchensGardenGame.prototype.getFlowerElem = function (color) {
        // debug(".token .flower ." + color);
        return document.querySelector(".token.flower." + color);
    };
    GretchensGardenGame.prototype.addStatics = function (c) {
        return this._cardManager.addStatics(c);
    };
    GretchensGardenGame.prototype.getPlantIdOnSpaceId = function (spaceId) {
    ...
    GretchensGardenGame.prototype.resetDecks = function () {
        Object.values(this._stocks).forEach(function (stock) {
            return stock.setSelectionMode("none");
        });
    };
    GretchensGardenGame.prototype.addResetButton = function () {
        var _this = this;
        if ($("btn-reset")) {
    ...
    */
    GretchensGardenGame.prototype.displayChoicesForDie = function () {
    ...
    GretchensGardenGame.prototype.updateBtnPay = function () {
    ...
    */
    GretchensGardenGame.prototype.notif_moveCard = function (n) {
        this._cardManager.updateCardInformations(n.args.card);
        this.activePossibleSlots();
    };
    //flag to change buttons
    GretchensGardenGame.prototype.notif_playerReady = function (n) {
        if (this.isItMe(n.args.player_id)) {
            $("btn-water").style.display = "none";
            $("btn-reset").style.display = "inline-block";
        }
    };
    GretchensGardenGame.prototype.notif_updateCard = function (n) {
        this._cardManager.updateCardInformations(n.args.card);
    };
    GretchensGardenGame.prototype.notif_updateDeck = function (n) {
    ...
    GretchensGardenGame.prototype.notif_updatePlayers = function (n) {
        this._playerManager.updatePlayers(n.args);
    };
    GretchensGardenGame.prototype.notif_pay = function (n) {
        this.pay(n.args.player_id, n.args.n);
        this._cardManager.updateCardInformations(n.args.moneyPlant);
    };
    GretchensGardenGame.prototype.notif_transfert = function (n) {
        var _this = this;
    ...
    GretchensGardenGame.prototype.notif_drawCard = function (n) {
    ...
    GretchensGardenGame.prototype.notif_refreshUi = function (n) {
    ...
    GretchensGardenGame.prototype.notif_clearTurn = function (n) {
        var _this = this;
    ...
    GretchensGardenGame.prototype.notif_startAction = function (n) {
        this._turnCounter.toValue(n.args.turn);
        if (n.args.turn == 12) {
            this.displayCaution();
        }
    };
    GretchensGardenGame.prototype.notif_newScore = function (n) {
    ...
    ░   ░███  ░  ░███  █ ░  ░███░█████░███  ░███    ░███ ░███        ░███    ░███ ░   ░███  ░  ░███  █ ░ ░███    ░░░
        ...
        */
    GretchensGardenGame.prototype.board_tpl = function (player) {
    ...
    // semi generic
    GretchensGardenGame.prototype.tplPlayerPanel = function (player) {
    ...
    GretchensGardenGame.prototype.setupCards = function (gamedatas) {
        var _this = this;
    ...
    GretchensGardenGame.prototype.updateCards = function (cards) {
        var _this = this;
        [/*"discardplant", "discardpot", */ "water"].forEach(function (deck) {
            if (cards[deck]) {
    ...
    GretchensGardenGame.prototype.updateWaterCans = function (players) {
        var _this = this;
    ...
    */
    GretchensGardenGame.prototype.addTooltips = function () {
        var _this = this;
        this._tooltips = [
    ...
    GretchensGardenGame.prototype.addUndoButton = function (condition, callback) {
        var _this = this;
    ...
    GretchensGardenGame.prototype.insertIcons = function (text, preventRecursion) {
    ...
    GretchensGardenGame.prototype.createNumberButtons = function (callback, valuesToDisable, from, to) {
     ...
     * @returns
     */
    GretchensGardenGame.prototype.arraySum = function (array) {
    ...
    GretchensGardenGame.prototype.addResetClientStateButton = function (callback, customLabel) {
        var _this = this;
    ...
    GretchensGardenGame.prototype.addPassButton = function (condition, callback, actionName) {
        var _this = this;
    ...
    GretchensGardenGame.prototype.displayTitle = function (title) {
        var formatedTitle = this.fsr(title, { you: this.coloredYou() });
        $("pagemaintitletext").innerHTML = formatedTitle;
    };
    GretchensGardenGame.prototype.resetTitle = function () {
        this.displayTitle(this.currentStateTitle);
    };
    GretchensGardenGame.prototype.displayCaution = function (text, bErasePrevious) {
     ...
     */
    GretchensGardenGame.prototype.addCounterOnDeck = function (containerId, initialValue) {
     ...
     */
    GretchensGardenGame.prototype.addImageActionButton = function (id, handler, tooltip, classes, bcolor) {
     ...
     *
     */
    GretchensGardenGame.prototype.getTokenDiv = function (key, args) {
    ...
    //
    //
    GretchensGardenGame.prototype.forEachPlayer = function (callback) {
        Object.values(this.gamedatas.players).forEach(callback);
    };
    GretchensGardenGame.prototype.getArgs = function () {
        return this.gamedatas.gamestate.args;
    };
    GretchensGardenGame.prototype.clientState = function (name, descriptionmyturn, args) {
    ...
    GretchensGardenGame.prototype.strReplace = function (str, subst) {
        return dojo.string.substitute(str, subst);
    };
    GretchensGardenGame.prototype.clearClientState = function () {
        this.clearPossible();
        this.restoreServerGameState();
    };
    GretchensGardenGame.prototype.translate = function (t) {
        if (typeof t === "object") {
    ...
    GretchensGardenGame.prototype.fsr = function (log, args) {
        return this.format_string_recursive(log, args);
    };
    GretchensGardenGame.prototype.onSelectN = function (elements, n, callback) {
        var _this = this;
